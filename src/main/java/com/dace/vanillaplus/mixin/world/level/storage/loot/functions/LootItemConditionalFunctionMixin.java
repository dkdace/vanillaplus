...
public abstract class LootItemConditionalFunctionMixin<T extends LootItemConditionalFunction> implements VPMixin<T> {
    @Shadow
    protected static <T extends LootItemConditionalFunction> Products.@UnknownNullability P1<RecordCodecBuilder.Mu<T>, List<LootItemCondition>> commonFields(RecordCodecBuilder.Instance<T> i) {
        return null;
    }
}
