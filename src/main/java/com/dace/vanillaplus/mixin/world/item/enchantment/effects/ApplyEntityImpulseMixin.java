...
public abstract class ApplyEntityImpulseMixin implements VPMixin<ApplyEntityImpulse>, VPLevelBasedProvider {
    @Shadow
    @Final
    private LevelBasedValue magnitude;

    @Override
    @NonNull
    public List<LevelBasedValue> getLevelBasedValues() {
        return Collections.singletonList(magnitude);
    }
}
