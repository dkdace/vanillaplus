...
public record BlockConfig(@NonNull VPDataComponentMap components) {
    ...
    public static final Codec<BlockConfig> DIRECT_CODEC = RecordCodecBuilder.create(instance -> instance
            .group(VPDataComponentMap.createCodec(StaticRegistry.BLOCK_CONFIG_COMPONENT_TYPE)
                    .optionalFieldOf("components", VPDataComponentMap.EMPTY).forGetter(BlockConfig::components))
